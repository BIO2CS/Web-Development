...
var module = (function() {
	...
	return {
		getP1Message: function() {
			return p1Message;
		},
		getP2Message: function() {
			return p2Message;
		},
		getP3Message: function() {
			return p3Message;
		},
		getP4Message: function() {
			return p4Message;
		}
	}
}());
...
window.cs142Project2Results = {
    p1Message: module.getP1Message(),
    p2Message: module.getP2Message(),
    p3Message: module.getP3Message(),
    p4Message: module.getP4Message()
};
...
window.onload = function () {
    document.getElementById("cs142p1").innerText = module.getP1Message();
    document.getElementById("cs142p2").innerText = module.getP2Message();
    document.getElementById("cs142p3").innerText = module.getP3Message();
    document.getElementById("cs142p4").innerText = module.getP4Message();
};
